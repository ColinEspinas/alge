...
import { Container, Graphics, utils, Renderer, settings, SCALE_MODES, Texture, Sprite as Sprite$1, Point, Text as Text$1, RenderTexture, BaseRenderTexture, BaseTexture, Rectangle } from 'pixi.js';
...
class Painter extends Component {
    ...
    init() {
        ...
        this.graphics.scale = new Point(this.scale.x, this.scale.y);
