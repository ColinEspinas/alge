...
let player1 = mainScene.AddEntity(Player, "PlayerEntity", "https://upload.wikimedia.org/wikipedia/commons/9/9a/Gull_portrait_ca_usa.jpg");
player1.AddComponent(PlayerController, "PlayerController");

let newScene : Scene = game.GetManager(SceneManager).CreateScene("test2");
let player2 = newScene.AddEntity(Player, "PlayerEntity", "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Image_created_with_a_mobile_phone.png/1280px-Image_created_with_a_mobile_phone.png");
